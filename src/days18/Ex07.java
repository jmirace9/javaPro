...
public class Ex07 {
	...
	public static void main(String[] args) {
		...
		System.out.println(hm); // {hong=홍길동, kenik=켄익, 어드민=관리자} key 가 중복이여도 오류나지않고 덮어쓰기.
		
		// [모든 key 출력]
		/*
		Set<String> kSet = hm.keySet(); // 모든키값 중복될일 없어서 Set
		...
		*/
		...
		// [모든 value 출력]
		Collection<String> vc = hm.values(); // 중복될수있어서 Collection
